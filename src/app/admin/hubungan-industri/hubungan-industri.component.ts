...
@Component({
    ...
    styleUrls: ['./hubungan-industri.component.css']
})
export class HubunganIndustriComponent implements OnInit{
  ...
  // Fungsi untuk melakukan pencarian
    ...
    getDataHubunganIndustri() {
        this.dataService.loadHubunganIndustri().subscribe((data: any) => {
